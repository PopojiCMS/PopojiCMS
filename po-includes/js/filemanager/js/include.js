...
! function(e, a, t) {
    ...
    function l(a) {
        ...
        var t;
        t = a.find(".rename-file-paths").attr(a.hasClass("directory") ? "data-path" : "data-path"), e.ajax({
            type: "POST",
            ...
            bootbox.dialog(a, [{
                ...
                callback: function() {
                    ...
                    if ("" != a && "undefined" != typeof a) {
                        ...
                        ("" == n || "undefined" == typeof n) && (n = "none"), e.ajax({
                            type: "POST",
        ...
        U = {
            contextActions: {
                ...
                select: function(a) {
                    var t, n = S(a),
                        i = e("#field_id").val(),
                        r = e("#return_relative_url").val();
                    if (1 == r && (n = n.replace(e("#base_url").val(), ""), n = n.replace(e("#cur_dir").val(), "")), t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)
                        if (1 == e("#crossdomain").val()) t.postMessage({
                            ...
                            var o = e("#" + i, t.document);
                            o.val(n).trigger("change"), "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(i), g()
                        }
                    else apply_any(n)
                },
                copy: function(e) {
                ...
                e.contextMenu({
                    ...
                    build: function(n) {
                        ...
                        return (n.find(".img-precontainer-mini .filetype").hasClass("png") || n.find(".img-precontainer-mini .filetype").hasClass("jpg") || n.find(".img-precontainer-mini .filetype").hasClass("jpeg")) && t && (i.items.edit_img = {
                            ...
                            icon: "dimension",
                            disabled: !0
                        }), i.items.size = n.hasClass("directory") ? {
    ...
    e(document).ready(function() {
        ...
        if ("" != t)
            if (1 == e("#crossdomain").val()) n.postMessage({
                ...
                v.val(a).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
            }
        else e.inArray(c, ext_img) > -1 ? s = '<img src="' + u + '" alt="' + l + '" />' : e.inArray(c, p) > -1 ? s = '<video controls source src="' + u + '" type="video/' + c + '">' + l + "</video>" : e.inArray(c, d) > -1 ? ("mp3" == c && (c = "mpeg"), s = '<audio controls src="' + u + '" type="audio/' + c + '">' + l + "</audio>") : s = '<a href="' + u + '" title="' + l + '">' + l + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
            sender: "responsivefilemanager",
            url: u,
            field_id: null,
            html: s
        ...
        if ("" != t)
            if (1 == e("#crossdomain").val()) n.postMessage({
                ...
                s.val(a).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
            }
        else apply_any(c)
