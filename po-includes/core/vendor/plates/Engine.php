...
namespace PoTemplate;

use PoTemplate\Extension\ExtensionInterface;
use PoTemplate\Template\Data;
use PoTemplate\Template\Directory;
use PoTemplate\Template\FileExtension;
use PoTemplate\Template\Folders;
use PoTemplate\Template\Func;
use PoTemplate\Template\Functions;
use PoTemplate\Template\Name;
use PoTemplate\Template\Template;
